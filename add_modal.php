...
<div class="row">
						<div class="col-lg-2">
							<label class="control-label" style="position:relative; top:7px;">Market:</label>
						</div>
						<div class="col-lg-10">
...
<div class="row">
					...
					<div class="row">
						<div class="col-lg-2">
							<label class="control-label" style="position:relative; top:7px;">Commodity:</label>
						</div>
						<div class="col-lg-10">
					...
					<div class="row">
						<div class="col-lg-2">
							<label class="control-label" style="position:relative; top:7px;">Supply:</label>
						</div>
						<div class="col-lg-10">
